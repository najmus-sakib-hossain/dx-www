...
- [x] 1. Update WASM bindings to use LLM format conversion
  - [x] 1.1 Update `wasm.rs` to use `llm_to_human` and `human_to_llm` functions
...
- [x] 2. Implement TypeScript LLM Parser
  ...
  - [x] 2.3 Implement reference section parser (`#:`)
    - Parse `#:key|value` format
    - Store in refs map
    - _Requirements: 1.2_
  - [x] 2.4 Implement data section parser (`#<letter>(schema)`)
    - Parse schema from parentheses
    - Parse subsequent rows as pipe-separated values
    - _Requirements: 1.3, 1.4_
  - [x] 2.5 Write property test for LLM parsing
    - **Property 1: LLM to Human to LLM Round-Trip**
    - **Validates: Requirements 1.1-1.9**

- [x] 3. Implement TypeScript Human Formatter
  - [x] 3.1 Create abbreviation dictionary
  ...
  - [x] 3.2 Implement section header formatter
    - Generate box-drawing character headers
    - Center section titles
    - _Requirements: 2.2_
  - [x] 3.3 Implement config section formatter
    - Format key-value pairs with expanded keys
    - Align values for readability
    - _Requirements: 2.1_
  - [x] 3.4 Implement data section table formatter
...
- [x] 4. Implement TypeScript Human Parser
  ...
  - [x] 4.4 Implement reference detection
    - Detect repeated strings
    - Create reference definitions
    - _Requirements: 3.5_
  - [x] 4.5 Write property test for Human to LLM round-trip
    - **Property 2: Human to LLM to Human Round-Trip**
    - **Validates: Requirements 3.1-3.5, 3.6**

- [x] 5. Checkpoint - Verify round-trip conversions
