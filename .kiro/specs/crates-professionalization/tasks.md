...
- [ ] 2. Checkpoint - Ensure validation infrastructure works
  - Run validation script against crates/ directory
  - Review generated report for accuracy
  - Ensure all tests pass, ask the user if questions arise

- [ ] 3. Implement file existence and cleanup validation
  - [ ] 3.1 Implement forbidden file detection
  ...
  - [ ] 3.3 Implement license compliance checking
  ...
  - [ ] 3.5 Implement Cargo.toml completeness validation
...
- [ ] 4. Checkpoint - Full validation working
  - Run complete validation and generate full report
  - Ensure all tests pass, ask the user if questions arise

- [ ] 5. Create templates and fix infrastructure
  - [ ] 5.1 Create README template
  ...
  - [ ] 5.2 Create Cargo.toml template
...
- [ ] 6. Execute cleanup and fixes
  - [ ] 6.1 Remove Cargo.lock from library crates
    - Identify all library crates with Cargo.lock
    - Remove Cargo.lock files
    - Update .gitignore if needed
    - _Requirements: 2.2_

  - [ ] 6.2 Remove/relocate development artifacts
  ...
  - [ ] 6.4 Remove empty documentation files
    - Delete crates/python/COMPABILITY.md (empty)
    - Scan for and remove other empty .md files
    - _Requirements: 5.3_

- [ ] 7. Checkpoint - Cleanup complete
  - Run validation to confirm cleanup success
  - Ensure all tests pass, ask the user if questions arise

- [ ] 8. Fix README documentation
  - [ ] 8.1 Rewrite crates/font/README.md
...
- [ ] 12. Final checkpoint - All validation passes
