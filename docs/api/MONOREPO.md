So for dx now I am creating dx-js-monorepo crate inside crates folder - It will have all features of pnpm workspace as even bun is bad at workspaces than pnpm - So by doing this dx-js-monorepo we will beat pnpm and turbo repo also in monorepo management!!!

Please use dx binary dawn game changing unique features to make it more powerfull and efficient!!!
