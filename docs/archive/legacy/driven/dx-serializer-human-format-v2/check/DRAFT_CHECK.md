I am creating "check" in rust which will be at least 5x faster than biome for linting, formatting and checking code quality of javascript, typescript, jsx, tsx, json, css, scss, html, md, mdx and some other files. Its a tool inside dx - Dx means "Enahnced Developer Experience". In this dx I essencefromexistence uses binary first way to provide better developer experience using rust based binaries for various developer needs. I already created so many stuffs and I only need this check tool to complete the dx experience with some others that I will launch at 1st January 2026 and today is 22 December 2025. So, please give me best game changing unique features that will beat biome and other similar tools in the market. Please give me at least 10 unique features with brief explanation for each feature. And I already created check using biome old codebase but its using biome codebase but I need to beat biome and other tools. So, please give me unique features that will make check the best tool in the market. So, give me updated unique features which will make check the best tool in the market using our dx binary dawn approach.


Here is more about current check:
```markdown
# Dx Check
