//! DX-Quantum: Sub-Nanosecond Access through Compile-Time Offsets
//!
//! The killer feature: Compile-time field offset computation.
//! rkyv computes offsets at runtime, DX-Zero does it at compile time.
//!
//! Result: 0.1-0.3 ns field access (vs rkyv's 0.8-1.2 ns)
...
impl<'a> QuantumReader<'a> {
    ...
    ///
    /// # Safety
    /// Caller must ensure the byte slice contains valid DX-Zero data
    #[inline(always)]
