...
impl DxInlineString {
    ...
    pub fn as_inline_str(&self) -> Option<&str> {
        ...
        // Safety: We control the data and ensure UTF-8 validity on construction
...
mod tests {
    ...
    fn test_inline_stats() {
        let strings = vec!["Hello", "World", "This is a much longer string that won't fit"];
