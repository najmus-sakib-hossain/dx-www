...
//!
//! For any byte sequence containing invalid UTF-8 in a string position,
//! the parser SHALL return a specific Utf8ValidationError.
...
mod property_tests {
    ...
    proptest! {
        ...
        /// Property 14a: Valid UTF-8 strings SHALL be accepted
        ///
        /// **Property 14: Invalid UTF-8 Handling**
        /// **Validates: Requirements 6.6**
        #[test]
        ...
        /// Property 14b: Valid UTF-8 with unicode SHALL be accepted
        ///
        /// **Property 14: Invalid UTF-8 Handling**
        /// **Validates: Requirements 6.6**
        #[test]
        ...
        /// Property 14c: Invalid UTF-8 SHALL return Utf8Error
        ///
        /// **Property 14: Invalid UTF-8 Handling**
        /// **Validates: Requirements 6.6**
        #[test]
        ...
        /// Property 14d: Error offset SHALL point to first invalid byte
        ///
        /// **Property 14: Invalid UTF-8 Handling**
        /// **Validates: Requirements 6.6**
        #[test]
        ...
        /// Property 14e: validate_string_input SHALL add base_offset to error offset
        ///
        /// **Property 14: Invalid UTF-8 Handling**
        /// **Validates: Requirements 6.6**
        #[test]
        ...
        /// Property 14f: Detailed validation SHALL provide description
        ///
        /// **Property 14: Invalid UTF-8 Handling**
        /// **Validates: Requirements 6.6**
        #[test]
        ...
        /// Property 14g: Empty input SHALL be valid UTF-8
        ///
        /// **Property 14: Invalid UTF-8 Handling**
        /// **Validates: Requirements 6.6**
        #[test]
        ...
        /// Property 14h: ASCII-only input SHALL always be valid
        ///
        /// **Property 14: Invalid UTF-8 Handling**
        /// **Validates: Requirements 6.6**
        #[test]
