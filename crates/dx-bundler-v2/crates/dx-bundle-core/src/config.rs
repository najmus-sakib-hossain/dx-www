//! Configuration for DX Bundler v2
...
impl Target {
    ...
    pub fn supports_async_await(&self) -> bool {
        matches!(self, Target::ES2017 | Target::ES2018 | Target::ES2019 
            | Target::ES2020 | Target::ES2021 | Target::ES2022 | Target::ES2023 
            | Target::ESNext | Target::Node16 | Target::Node18 | Target::Node20)
    }
    
    /// Check if target supports optional chaining
    pub fn supports_optional_chaining(&self) -> bool {
        matches!(self, Target::ES2020 | Target::ES2021 | Target::ES2022 
            | Target::ES2023 | Target::ESNext | Target::Node16 | Target::Node18 | Target::Node20)
    }
}
