//! DX Bundler v2 CLI - 3x faster than Bun!
...
#[command(about = "DX Bundler v2 - 3x faster than Bun", long_about = None)]
#[command(version)]
struct Cli {
    #[command(subcommand)]
    command: Commands,
...
async fn bundle_command(
    ...
    println!("⚡ DX Bundler v2 - 3x Faster Than Bun");
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
    ...
    if !no_simd && dx_bundle_simd::simd_available() {
...
fn bench_command(entries: Vec<PathBuf>, runs: usize) -> anyhow::Result<()> {
    println!("🔥 Benchmarking DX Bundler v2");
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n");
