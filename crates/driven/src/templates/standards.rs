...
impl StandardsTemplate {
    ...
    pub fn rust_idioms() -> Self {
        Self {
            ...
            rules: vec![
                (RuleCategory::Naming, 0, "Use snake_case for functions and variables".to_string()),
                ...
                (RuleCategory::Style, 0, "Prefer &str over String for function parameters".to_string()),
                (RuleCategory::Style, 1, "Use iterators instead of manual loops when possible".to_string()),
                (RuleCategory::Style, 2, "Prefer Option and Result over nulls and exceptions".to_string()),
                (RuleCategory::ErrorHandling, 0, "Use ? operator for error propagation".to_string()),
                (RuleCategory::ErrorHandling, 1, "Create custom error types for libraries".to_string()),
                (RuleCategory::Performance, 0, "Prefer references over cloning when possible".to_string()),
                (RuleCategory::Performance, 1, "Use Cow<str> for potentially owned strings".to_string()),
            ],
            tags: vec!["rust".to_string(), "idioms".to_string(), "patterns".to_string()],
        }
    }
    ...
    pub fn error_handling() -> Self {
        Self {
            ...
            rules: vec![
                ...
                (RuleCategory::ErrorHandling, 1, "Provide context with error messages".to_string()),
                (RuleCategory::ErrorHandling, 2, "Use structured error types, not strings".to_string()),
                (RuleCategory::ErrorHandling, 3, "Handle errors at the appropriate level".to_string()),
                (RuleCategory::ErrorHandling, 4, "Log errors with sufficient context for debugging".to_string()),
                (RuleCategory::ErrorHandling, 5, "Consider user experience when displaying errors".to_string()),
            ],
            tags: vec!["errors".to_string(), "handling".to_string(), "exceptions".to_string()],
        }
    }
    ...
    pub fn testing() -> Self {
        Self {
            ...
            rules: vec![
                ...
                (RuleCategory::Testing, 1, "Use descriptive test names that explain the scenario".to_string()),
                ...
                (RuleCategory::Testing, 5, "Prefer integration tests for complex workflows".to_string()),
    ...
    pub fn documentation() -> Self {
        Self {
            ...
            rules: vec![
                ...
                (RuleCategory::Documentation, 2, "Document error conditions and panics".to_string()),
                (RuleCategory::Documentation, 3, "Keep documentation up to date with code".to_string()),
            ...
            tags: vec!["documentation".to_string(), "docs".to_string(), "comments".to_string()],
        }
    }
    ...
    pub fn git_conventions() -> Self {
        Self {
            ...
            rules: vec![
                (RuleCategory::Git, 0, "Use conventional commit messages (feat:, fix:, docs:, etc.)".to_string()),
            ...
            tags: vec!["git".to_string(), "commits".to_string(), "branching".to_string()],
        }
    }
}
