...
impl BinaryPatch {
    ...
    pub fn to_bytes(&self) -> [u8; Self::HEADER_SIZE] {
        ...
        [target_bytes[0], target_bytes[1], self.op as u8, self.value_len]
    }
...
mod tests {
    ...
    fn test_increment_patch_size() {
        ...
        let (patch, value) = BinaryPatch::set_text(1, "42");
