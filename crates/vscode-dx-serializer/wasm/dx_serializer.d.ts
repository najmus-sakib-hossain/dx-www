...
export interface InitOutput {
  ...
  readonly deflate: (a: number, b: number) => [number, number];
  readonly deflaterjs_deflate: (a: number, b: number, c: number) => [number, number];
  readonly deflaterjs_jsonToDense: (a: number, b: number, c: number) => [number, number, number, number];
  readonly deflaterjs_new: () => number;
  readonly deflaterjs_withConfig: (a: number) => number;
  readonly hologramVersion: () => [number, number];
  ...
  readonly inflate: (a: number, b: number) => [number, number];
  readonly inflate_ascii: (a: number, b: number) => [number, number];
  readonly inflate_compact: (a: number, b: number) => [number, number];
  readonly inflaterjs_inflate: (a: number, b: number, c: number) => [number, number];
  readonly inflaterjs_new: () => number;
  readonly inflaterjs_withConfig: (a: number) => number;
  readonly json_to_dense: (a: number, b: number) => [number, number, number, number];
  ...
  readonly serializerVersion: () => [number, number];
  ...
  readonly transformresult_content: (a: number) => [number, number];
  readonly transformresult_error: (a: number) => [number, number];
  readonly transformresult_success: (a: number) => number;
  readonly validationresult_column: (a: number) => number;
  readonly validationresult_error: (a: number) => [number, number];
  readonly validationresult_hint: (a: number) => [number, number];
