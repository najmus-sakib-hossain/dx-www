...
pub static MACRO_DICT: Lazy<HashMap<MacroId, &'static str>> = Lazy::new(|| {
    ...
    map.insert(10009, "font-size:0.875rem;line-height:1.25rem;color:#4b5563;margin-bottom:0.5rem");
...
pub fn analyze_for_macros(patterns: &[(Vec<String>, usize)], threshold: usize) -> Vec<(Vec<String>, usize)> {
    patterns
        .iter()
