...
impl DpbPrettyPrinter {
    ...
    fn interpret_arg(opcode: DpbOpcode, arg: u32, module: &DpbModule) -> String {
        match opcode {
            ...
            DpbOpcode::LoadGlobal | DpbOpcode::StoreGlobal | DpbOpcode::DeleteGlobal |
            DpbOpcode::LoadAttr | DpbOpcode::StoreAttr | DpbOpcode::DeleteAttr |
            DpbOpcode::LoadName | DpbOpcode::StoreName | DpbOpcode::LoadMethod |
            DpbOpcode::ImportName | DpbOpcode::ImportFrom => {
                module.get_name(arg).unwrap_or("?").to_string()
            }
            DpbOpcode::Jump | DpbOpcode::JumpIfTrue | DpbOpcode::JumpIfFalse |
            DpbOpcode::JumpIfTrueOrPop | DpbOpcode::JumpIfFalseOrPop |
            DpbOpcode::PopJumpIfTrue | DpbOpcode::PopJumpIfFalse |
            DpbOpcode::PopJumpIfNone | DpbOpcode::PopJumpIfNotNone |
            DpbOpcode::ForIter => {
                format!("to {:04X}", arg)
            }
...
mod tests {
    ...
    fn create_test_module() -> std::sync::Arc<DpbModule> {
        ...
        let code = CodeObject {
            ...
            code: vec![
                DpbOpcode::LoadConst as u8, 0, 0,  // Load 42
                DpbOpcode::StoreFast as u8, 0, 0,  // Store to local 0
                DpbOpcode::LoadFast as u8, 0, 0,   // Load local 0
                DpbOpcode::LoadConst as u8, 1, 0,  // Load 10
    ...
    fn test_format_constant() {
        ...
        assert_eq!(DpbPrettyPrinter::format_constant(&Constant::String("hello".to_string())), "\"hello\"");
    }
