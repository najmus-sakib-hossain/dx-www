...
impl DeoptFrame {
    ...
    pub fn restore_value(&mut self, location: &ValueLocation, registers: &[u64], stack: &[u64], constants: &[u64]) {
...
mod tests {
    ...
    fn test_remove_function() {
        ...
        handler.register(0x1000, DeoptInfo {
            func_id: FunctionId(1),
            bytecode_offset: 0,
            value_locations: vec![],
        ...
        handler.register(0x2000, DeoptInfo {
