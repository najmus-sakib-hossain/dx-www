...
fn test_cpu_profiler() {
    use dx_js_runtime::profiler::{CpuProfiler, CpuProfile};
...
fn test_simd_operations() {
    use dx_js_runtime::simd::{SimdF32x4, SimdI32x4, vector_add_f32};
...
#[test]
fn test_wasm_module() {
    use dx_js_runtime::wasm::{WasmModule, WasmExport, WasmType, WasmMemory};
    
    let mut module = WasmModule::new("test".to_string());
    
    module.add_export("add".to_string(), WasmExport::Function {
