...
- pusher-js (45 KB)
- @liveblocks/client (60 KB)

**Total replaced:** 190 KB → **0 KB**

## Example

```typescript
// Client-side
const channel = sync.subscribe("chat:lobby");
...
| Message latency | 10-30 ms | < 5 ms | **2-6×** |
| Protocol overhead | JSON | Binary | **10× less bytes** |
| Reconnect time | Manual | < 100 ms | **Automatic** |
| Delta updates | Not built-in | XOR-based | **New feature** |

## Binary Protocol

| Opcode | Hex | Description |
|--------|-----|-------------|
| SYNC_SUBSCRIBE | 0xA0 | Subscribe to channel |
| SYNC_UNSUBSCRIBE | 0xA1 | Unsubscribe |
| SYNC_MESSAGE | 0xA2 | Broadcast message |
| SYNC_DELTA | 0xA3 | Delta update (XOR diff) |
| SYNC_ACK | 0xA4 | Acknowledge receipt |
