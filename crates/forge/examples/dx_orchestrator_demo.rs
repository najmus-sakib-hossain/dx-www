...
fn main() -> Result<()> {
    ...
    executor.configure(DxToolId::NodeModules, ToolConfig {
        enabled: true,
        parallel: false,
        cache_enabled: true,
        r2_sync: true,
    ...
    executor.configure(DxToolId::Style, ToolConfig {
        enabled: true,
        parallel: true,
        cache_enabled: true,
        r2_sync: false,
    ...
    executor.configure(DxToolId::Test, ToolConfig {
        enabled: true,
        parallel: true,
        cache_enabled: true,
        r2_sync: false,
    ...
    let entry = executor.cache().cache_content(
        DxToolId::Bundler,
        &source_path,
        test_content,
    )?;
