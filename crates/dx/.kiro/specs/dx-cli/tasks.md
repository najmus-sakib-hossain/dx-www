...
- [x] 3. Checkpoint - Ensure I/O layer compiles on all platforms
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Implement UI Theme System
  - [x] 4.1 Create Theme struct with color styles
  ...
  - [x] 4.2 Implement Theme output methods
    - Implement print_logo(), success(), error(), info(), warn()
    - Implement step(), hint(), suggest_command()
    - _Requirements: 2.3, 2.4, 2.5, 2.6, 2.7, 2.8_

  - [x] 4.3 Write property test for message prefix formatting
    - **Property 2: Message Prefix Formatting**
    - **Validates: Requirements 2.4, 2.5, 2.6, 2.7**

  - [x] 4.4 Write property test for color-disabled output
    - **Property 3: Color-Disabled Output Purity**
    - **Validates: Requirements 2.2**

  - [x] 4.5 Write property test for step indicator format
    - **Property 4: Step Indicator Format**
    - **Validates: Requirements 2.8**

- [x] 5. Implement Spinner Component
  - [x] 5.1 Create Spinner struct with indicatif ProgressBar
    - Configure spinner style with animation characters
    - Set 80ms tick interval
    - _Requirements: 3.1_

  - [x] 5.2 Implement Spinner methods
    - Implement new(), set_message(), finish_success(), finish_error(), finish_warn()
    - _Requirements: 3.2, 3.3, 3.4, 3.5_

- [x] 6. Implement Progress Bar Component
  - [x] 6.1 Create Progress struct
    - Implement new() with bar template
    - Implement download() with bytes/speed template
    - _Requirements: 4.1, 4.2_

  - [x] 6.2 Create MultiProgressBar struct
    - Implement add() to create new bars
    - Implement set() to update specific bars
    - _Requirements: 4.3_

  - [x] 6.3 Write property test for multi-progress bar
    - **Property 5: Multi-Progress Bar Addition**
    - **Validates: Requirements 4.3**

- [x] 7. Checkpoint - Ensure UI components work
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Implement CLI Parser
  - [x] 8.1 Define Cli struct with clap derive
    - Add global flags: no_color, verbose, quiet, config
    - _Requirements: 5.5_

  - [x] 8.2 Define Commands enum with all subcommands
  ...
  - [x] 8.3 Define argument structs for each command
  ...
  - [x] 8.4 Write unit tests for CLI parsing
...
- [x] 9. Implement Command Router
  - [x] 9.1 Implement Cli::execute() method
    - Route each command variant to its handler
    - Pass reactor and theme to handlers
    - _Requirements: 5.6_

  - [x] 9.2 Implement default behavior (no command)
    - Display logo and helpful hint
    - _Requirements: 5.6_

  - [x] 9.3 Implement stub handlers for all commands
...
- [x] 11. Checkpoint - Ensure CLI structure works
  - Ensure all tests pass, ask the user if questions arise.

- [x] 12. Implement Error Types
  - [x] 12.1 Define DxError enum with thiserror
...
- [x] 13. Implement Path Utilities
  ...
  - [x] 13.5 Write property tests for path handling
    - **Property 18: Path Separator Handling**
    - **Property 19: Home Directory Expansion**
    - **Validates: Requirements 11.1, 11.2**

  - [x] 13.6 Write property test for symlink resolution
    - **Property 20: Symlink Resolution Depth**
    - **Validates: Requirements 11.4**

  - [x] 13.7 Write property test for CI/container detection
    - **Property 21: CI/Container Detection**
    - **Validates: Requirements 11.7**

- [x] 14. Checkpoint - Ensure utilities work
  - Ensure all tests pass, ask the user if questions arise.

- [x] 15. Implement Configuration Management
  - [x] 15.1 Define DxConfig struct
...
- [x] 16. Implement Update Checker
  ...
  - [x] 16.3 Implement update display
    - Show current and new version
    - Show release notes summary
    - _Requirements: 6.2, 6.7_

  - [x] 16.4 Write property test for version display
    - **Property 6: Update Version Display**
    - **Validates: Requirements 6.2**

  - [x] 16.5 Write property test for delta preference
    - **Property 7: Delta Patch Preference**
    - **Validates: Requirements 6.3**

- [x] 17. Implement Delta Patcher
  - [x] 17.1 Create DeltaPatcher struct
    - Store reactor reference
    - _Requirements: 7.1_

  - [x] 17.2 Implement signature verification
    - Verify Ed25519 signature on patch data
    - Return SignatureInvalid error on failure
    - _Requirements: 6.4, 6.5, 7.2_

  - [x] 17.3 Implement apply() method
    - Download patch file
    - Verify signature
    - Apply bsdiff patch
  ...
  - [x] 17.4 Implement fallback to full download
    - On patch failure, download full binary
    - _Requirements: 7.4_

  - [x] 17.5 Write property test for signature failure
    - **Property 8: Signature Verification Failure**
    - **Validates: Requirements 6.5**

  - [x] 17.6 Write property test for patch application
    - **Property 9: Delta Patch Application**
    - **Validates: Requirements 7.1**

- [x] 18. Implement Self-Update Command
  - [x] 18.1 Implement run_update() function
    - Check for updates
    - Confirm with user
  ...
  - [x] 18.2 Implement atomic binary replacement
    - Write to temp file
    - Set executable permissions (Unix)
    - Atomic rename
    - _Requirements: 6.6_

- [x] 19. Checkpoint - Ensure update system works
  - Ensure all tests pass, ask the user if questions arise.

- [x] 20. Implement Shell Integration
  - [x] 20.1 Define ShellType enum
    - Add variants: Bash, Zsh, Fish, PowerShell, Nushell
    - Implement detect() from SHELL env var
    - Implement config_path() for each shell
    - _Requirements: 8.1, 8.6_

  - [x] 20.2 Implement generate_integration()
  ...
  - [x] 20.3 Implement install_shell()
    - Detect or accept shell type
    - Check for existing installation
    - Append integration to config file
    - _Requirements: 8.5, 8.6_

  - [x] 20.4 Write property test for script content
    - **Property 10: Shell Integration Script Content**
    - **Validates: Requirements 8.2, 8.3**

  - [x] 20.5 Write property test for duplicate detection
    - **Property 11: Shell Integration Duplicate Detection**
    - **Validates: Requirements 8.5**

  - [x] 20.6 Write property test for config path mapping
