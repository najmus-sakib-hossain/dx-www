...
use crate::protocol::{HbtpHeader, HbtpFlags, MessageType, ArrayMetadata, ArrayDtype};
use crate::shared_memory::{SharedMemoryArena, SharedArrayHandle, SharedMemoryError};
...
impl HbtpMessage {
    ...
    pub fn from_bytes(bytes: &[u8]) -> Result<Self, ChannelError> {
        ...
        let header = HbtpHeader::from_bytes(&header_bytes)
