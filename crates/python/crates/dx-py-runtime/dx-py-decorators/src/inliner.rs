...
pub struct DecoratorInliner {
    ...
    custom_decorators: HashMap<String, Box<dyn Fn(&[u8]) -> InlineResult + Send + Sync>>,
}
...
impl DecoratorInliner {
    ...
    pub fn inline(
        ...
        match decorator {
            ...
            InlineableDecorator::Dataclass { frozen, slots, eq, order, hash } => {
...
mod tests {
    ...
    fn test_custom_decorator() {
        ...
        let result = inliner.inline(
            &InlineableDecorator::Custom("my_decorator".to_string()),
            &[],
            None,
        );
