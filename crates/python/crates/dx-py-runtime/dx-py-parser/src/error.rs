        ...
        match self {
            ...
            Self::IndentationError { message, .. } => {
                if message.contains("inconsistent") {
                    ...
                    Some(Suggestion {
                        message: "Check that your indentation matches the surrounding code".to_string(),
                        replacement: None,
                    })
                } else {
                    None
            ...
            Self::InvalidString { message, .. } => {
                if message.contains("unterminated") {
                    ...
                    Some(Suggestion {
                        message: "Use a raw string (r\"...\") or escape the backslash (\\\\)".to_string(),
                        replacement: None,
                    })
                } else {
                    None
...
mod tests {
    ...
    fn test_indentation_suggestion() {
        let err = ParseError::indentation_error(
            Location::new(2, 1, 10),
