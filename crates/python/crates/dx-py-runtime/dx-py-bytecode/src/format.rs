...
impl DpbOpcode {
    ...
    pub fn arg_size(&self) -> usize {
        match self {
            // No argument
            Self::PopTop | Self::DupTop | Self::DupTopTwo | Self::Swap |
            Self::Return | Self::Yield | Self::GetIter | Self::GetLen |
            Self::UnaryNeg | Self::UnaryPos | Self::UnaryInvert | Self::UnaryNot |
            Self::BinaryAdd | Self::BinarySub | Self::BinaryMul | Self::BinaryDiv |
            Self::BinaryFloorDiv | Self::BinaryMod | Self::BinaryPow |
            Self::BinaryAnd | Self::BinaryOr | Self::BinaryXor |
            Self::BinaryLshift | Self::BinaryRshift | Self::BinaryMatMul |
            Self::InplaceAdd | Self::InplaceSub | Self::InplaceMul | Self::InplaceDiv |
            Self::InplaceFloorDiv | Self::InplaceMod | Self::InplacePow |
            Self::InplaceAnd | Self::InplaceOr | Self::InplaceXor |
            Self::InplaceLshift | Self::InplaceRshift | Self::InplaceMatMul |
            Self::CompareLt | Self::CompareLe | Self::CompareEq | Self::CompareNe |
            Self::CompareGt | Self::CompareGe | Self::CompareIs | Self::CompareIsNot |
            Self::CompareIn | Self::CompareNotIn | Self::ExceptionMatch |
            Self::Reraise | Self::Nop | Self::PushNull | Self::EndSend |
            Self::LoadSubscr | Self::StoreSubscr | Self::DeleteSubscr => 0,
            
            // 1-byte argument
            Self::RotN | Self::Copy | Self::UnpackSequence | Self::UnpackEx |
            Self::BuildTuple | Self::BuildList | Self::BuildSet | Self::BuildDict |
            Self::BuildString | Self::BuildSlice | Self::FormatValue |
            Self::Raise | Self::Resume | Self::Cache | Self::Precall |
            Self::BinaryOp | Self::CompareOp | Self::ContainsOp => 1,
            
            // 2-byte argument (most common)
            Self::LoadFast | Self::StoreFast | Self::LoadConst | Self::LoadGlobal |
            Self::StoreGlobal | Self::LoadAttr | Self::StoreAttr |
            Self::DeleteFast | Self::DeleteGlobal | Self::DeleteAttr |
            Self::LoadName | Self::StoreName | Self::LoadDeref | Self::StoreDeref |
            Self::LoadClassDeref | Self::LoadMethod |
            Self::Jump | Self::JumpIfTrue | Self::JumpIfFalse |
            Self::JumpIfTrueOrPop | Self::JumpIfFalseOrPop |
            Self::PopJumpIfTrue | Self::PopJumpIfFalse |
            Self::PopJumpIfNone | Self::PopJumpIfNotNone |
            Self::ForIter | Self::YieldFrom |
            Self::Call | Self::CallKw | Self::CallEx | Self::CallMethod |
            Self::MakeFunction | Self::MakeClosure | Self::KwNames |
            Self::ListAppend | Self::SetAdd | Self::MapAdd |
            Self::ListExtend | Self::SetUpdate | Self::DictUpdate | Self::DictMerge |
            Self::SetupTry | Self::PopExcept | Self::PushExcInfo | Self::CheckExcMatch |
            Self::CleanupThrow | Self::SetupFinally | Self::SetupWith | Self::BeforeWith |
            Self::ImportName | Self::ImportFrom | Self::ImportStar | Self::SetupAnnotations |
            Self::GetAwaitable | Self::GetAiter | Self::GetAnext | Self::EndAsyncFor |
            Self::BeforeAsyncWith | Self::SetupAsyncWith | Self::Send | Self::AsyncGenWrap => 2,
    ...
    pub fn stack_effect(&self, arg: u32) -> i32 {
        match self {
            Self::LoadFast | Self::LoadConst | Self::LoadGlobal | Self::LoadAttr |
            Self::LoadName | Self::LoadDeref | Self::LoadClassDeref |
            Self::DupTop | Self::PushNull | Self::LoadMethod => 1,
            
            Self::DupTopTwo => 2,
            
            Self::StoreFast | Self::StoreGlobal | Self::StoreAttr |
            Self::StoreName | Self::StoreDeref | Self::PopTop |
            Self::DeleteFast | Self::DeleteGlobal | Self::DeleteAttr => -1,
            ...
            Self::CompareLt | Self::CompareLe | Self::CompareEq | Self::CompareNe |
            Self::CompareGt | Self::CompareGe | Self::CompareIs | Self::CompareIsNot |
            Self::CompareIn | Self::CompareNotIn |
            Self::LoadSubscr | Self::StoreSubscr => -1,
