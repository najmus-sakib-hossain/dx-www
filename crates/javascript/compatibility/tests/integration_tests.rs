...
mod core_tests {
    ...
    fn test_platform_detection() {
        ...
        assert!(
            matches!(platform, Platform::Linux | Platform::MacOS | Platform::Windows | Platform::Unknown),
    ...
    fn test_system_info() {
        ...
        assert!(matches!(info.platform, Platform::Linux | Platform::MacOS | Platform::Windows | Platform::Unknown));
        assert!(matches!(info.arch, Architecture::X64 | Architecture::Arm64 | Architecture::Unknown));
    ...
    fn test_error_code_from_io_error() {
        ...
        let other = Error::new(ErrorKind::Other, "test");
