...
pub fn generate_micro(
    ...
    // Build the complete Rust file
    let mut output = Vec::new();

    // Header
    output.push("//! Generated by dx-compiler (Micro Mode)".to_string());
    output.push("//! DO NOT EDIT - This file is automatically generated".to_string());
    ...
    output.push("    fn host_create_text(text_ptr: *const u8, text_len: u32) -> u32;".to_string());
    ...
    output.push("// Event types".to_string());
    output.push("const EVENT_CLICK: u32 = 0;".to_string());
    output.push("const EVENT_INPUT: u32 = 1;".to_string());
    output.push("const EVENT_CHANGE: u32 = 2;".to_string());
    output.push("const EVENT_SUBMIT: u32 = 3;".to_string());
    output.push("".to_string());
