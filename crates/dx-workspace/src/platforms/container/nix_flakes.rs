...
impl NixFlakesGenerator {
    ...
    fn generate_flake(&self, config: &WorkspaceConfig) -> String {
        ...
        lines.push("# dx-workspace generated Nix Flake".to_string());
        lines.push("{".to_string());
        lines.push("  description = \"dx development environment\";".to_string());
        lines.push(String::new());

        // Inputs
        lines.push("  inputs = {".to_string());
        lines.push("    nixpkgs.url = \"github:NixOS/nixpkgs/nixos-unstable\";".to_string());
    ...
    fn generate_envrc(&self) -> String {
        ...
        lines.push("# dx-workspace generated direnv configuration".to_string());
        lines.push("use flake".to_string());
        lines.push(String::new());
        lines.push("# Watch additional files for changes".to_string());
        lines.push("watch_file flake.nix".to_string());
        lines.push("watch_file flake.lock".to_string());
