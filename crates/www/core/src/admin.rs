...
mod tests {
    ...
    fn test_route_generation() {
        ...
        // Check index route
        assert!(routes.iter().any(|r| r.path == "/admin" && r.route_type == AdminRouteType::Index));
        
        // Check user routes
        assert!(routes.iter().any(|r| r.path == "/admin/users" && r.route_type == AdminRouteType::List));
        assert!(routes.iter().any(|r| r.path == "/admin/users/new" && r.route_type == AdminRouteType::Create));
        assert!(routes.iter().any(|r| r.path == "/admin/users/:id" && r.route_type == AdminRouteType::Edit));
    }
