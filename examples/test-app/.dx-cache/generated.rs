...
static STR_GREETING_3: &[u8] = b"greeting";
...
pub extern "C" fn render() {
    unsafe {
        // Template 0: [div class="greeting"]
        let node_0 = host_create_element(STR_DIV_2.as_ptr(), STR_DIV_2.len() as u32);
        host_set_attr(node_0, STR_CLASS_0.as_ptr(), STR_CLASS_0.len() as u32, STR_GREETING_3.as_ptr(), STR_GREETING_3.len() as u32);
