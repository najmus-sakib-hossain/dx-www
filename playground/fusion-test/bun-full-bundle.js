...
function Counter() {
  ...
  return createElement(Fragment, null, createElement("h1", null, "Count: " + count + " (doubled: " + doubled + ")"), createElement(MemoizedButton, { onClick: increment }, "Increment"), createElement("ul", null, items.map((item, i) => createElement("li", { key: i }, "Item " + item))));
}
