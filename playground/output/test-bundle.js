...
__dx_define(0,function(exports,require,module){ function Component({ count, onClick }) { return null; } function UnusedComponent() { return ; }});
__dx_define(1,function(exports,require,module){function useState(initial){ let state = initial; const setState = (newValue) => { state = newValue; render(); }; return [state, setState]; } function useEffect(fn, deps) { fn(); } exports.helpers = { format: (value)=> `Count: ${value}`, parse: (str)=> parseInt(str, 10), };});
